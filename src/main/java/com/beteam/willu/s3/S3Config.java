...
//    private String awsRegion = System.getenv("AWS_REGION");  // 시스템 환경 변수에서 리전 값 가져오기
    ...
    @Value("액세스 키 값 주입 받기")  // 액세스 키 값 주입 받기
    private String awsAccessKey;

    @Value("시크릿 키 값 주입 받기")  // 시크릿 키 값 주입 받기
    private String awsSecretKey;

    @Value("리전 값 주입 받기")      // 리전 값 주입 받기
...
//                .withEndpointConfiguration(new AwsClientBuilder.EndpointConfiguration("s3.amazonaws.com", awsRegion))  // 리전 설정
